        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourcePage = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VenueText = table.Column<string>(type: "character varying(180)", maxLength: 180, nullable: false),
                    PriceText = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                    CapacityInfo = table.Column<int>(type: "integer", nullable: true),
                    ...
                    FullDescription = table.Column<string>(type: "character varying(8000)", maxLength: 8000, nullable: false),
                    WhatToExpect = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Subject = table.Column<string>(type: "character varying(220)", maxLength: 220, nullable: false),
                    Status = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    ErrorMessage = table.Column<string>(type: "character varying(1200)", maxLength: 1200, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewsletterDispatchLogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Email = table.Column<string>(type: "character varying(180)", maxLength: 180, nullable: false),
                    PrefBreathwork = table.Column<bool>(type: "boolean", nullable: false),
                    PrefHorses = table.Column<bool>(type: "boolean", nullable: false),
                    PrefVeterinary = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsletterDispatchLogs_CourseId_SubscriberId",
                table: "NewsletterDispatchLogs",
